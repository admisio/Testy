<script lang="ts">
  ...
  <form method="POST" use:enhance>
    <article>
      ...
      <label>
        Username
        <input name="username" type="username" required bind:this={usernameInput} class="border-4" />
      </label>
      <label>
        Password
        <input name="password" type="password" required bind:this={passwordInput} class="border-4" />
      </label>
      <footer>
        {#if returnTo}
