...
<div class:dark={isDarkMode} class="w-100vw mt-12 flex h-full justify-center">
    <div class="md:w-7/10 w-[95%] px-3 py-6 shadow-2xl dark:bg-gray-700 md:px-24">
        <div class="rounded-md bg-gray-600 px-4 py-4 shadow-md flex justify-center">
            <span class="flex text-2xl font-bold text-white text-center">
                Váš výsledek: <span class="ml-2">
                    {data.submission?.evaluation}/10 bodů
                </span>
            </span>
        </div>
