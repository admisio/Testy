...
>
    ...
    <button
        disabled
        type="button"
        class="mr-2 inline-flex items-center rounded-lg border-2 border-[#3580b7] px-5 py-2.5 text-center text-sm font-medium text-[#3580b7] shadow-md"
    >
        <svg
            aria-hidden="true"
            role="status"
            class="mr-3 inline h-4 w-4 animate-spin text-[#3580b7]"
            viewBox="0 0 100 101"
            fill="none"
